...
#     # Scale features
#     scaled_features = scalar.transform(feature_array)
...
# Load scaler
scaler = pickle.load(open(r"C:\Users\ADMIN\Desktop\AI_PROJECT1\Mayuri\models\scaler.pkl", 'rb'))

# Load model
model = pickle.load(open(r"C:\Users\ADMIN\Desktop\AI_PROJECT1\Mayuri\models\model.pkl", 'rb'))
